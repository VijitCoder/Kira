 ...
 *
 * Исхожу из предположения: контроллер в первую очередь работает для ответа в браузер какой-то html-страницей. Поэтому
 * класс содержит методы отрисовки шаблонов, поля для заголовка страницы и мета-тегов.
 */
class Controller
{
    /**
