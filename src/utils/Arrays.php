...
class Arrays
{
     ...
     *
     * Прим: в комментарии к справке другое объединение, там числовые ключи заменяются так же, как и строковые.
     *
     * Логика объединения:
     ...
     * при этом числовые ключи не сохраняются, т.е. происходит <b>произвольная</b> переиндексация массива.
     *
     * Добавлен опциональный флаг, который позволит обработать числовые ключи, как строковые. Т.е. заменять значения
     * числовых ключей, а не дописывать в конец результирующего массива.
     *
     * Схематично результат объединения (для строковых ключей):
     * <pre>
