...
{
    //$replaces = require APP_PATH . '/conf/ns_replaces.php';
 ...
 * @DEPRECATED
 *
 * Самодельный автозагрузка классов.
 *
...
{
    $core = ['App', 'Controller', 'Db', 'Form', 'Router', 'Session', 'Utils', 'Validator'];
